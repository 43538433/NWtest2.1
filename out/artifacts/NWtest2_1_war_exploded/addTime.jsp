...
<form id="timeForm" method="post">
    ...
    <div>
        ...
        <%String colloge = (String) session.getAttribute("colloge");%>
        ...
        <input type="text" id="colloge" name="colloge" disabled="disabled" value="<%=colloge%>">
        <input type="hidden" id="id" name="user_id" value="<%=user_id%>">
        <input type="date" id="time" name="time" value="<fmt:formatDate value="${Time}" pattern="yyyy-MM-dd" />"
               placeholder="请输入时间">
